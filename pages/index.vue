        ...
        <UContainer class="py-8">
            <UCard class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <UCard>
                        <template #header>
                            <h2 class="text-lg font-semibold">名单 A</h2>
                        </template>
                        <UTextarea
                            v-model="listA"
                            :rows="12"
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            ...
                            >
                                ...
                                <UBadge
                                    :color="
                                        listAStats.invalid > 0 ? 'red' : 'gray'
                                    "
                                    variant="subtle"
                                    >{{ listAStats.invalid }}</UBadge
                                >
                                个无效姓名
                            </p>
                        </div>
                        ...
                        <div v-if="listAStats.invalid > 0" class="mt-3">
                            <UAccordion>
                                <UAccordionItem>
                                    <template #label>无效姓名列表</template>
                                    <UList class="max-h-36 overflow-y-auto">
                                        <UListItem
                                            v-for="(
                                                name, index
                                            ) in getInvalidNames(listA)"
                                            :key="index"
                                        >
                                            {{ name }}
                                        </UListItem>
                    ...
                    <UCard>
                        <template #header>
                            <h2 class="text-lg font-semibold">名单 B</h2>
                        </template>
                        <UTextarea
                            v-model="listB"
                            :rows="12"
